...
function ToDo() {
    ...
    return (
        <div className='main-container' id='main-container'>
            <h2 id='header'>To Do App <span onClick={showSettings} className='settings-header' id='settings-header'>Settings</span></h2>
            ...
            <ol>
                {tasks.map((task, index) => (
                    <li key={index} style={{ textDecoration: task.done ? 'line-through' : 'none' }}>
                        ...
                        <button className='add-task remove-task' onClick={() => removeTasks(index)} style={restButtonStyle}>Remove Task</button>
                        <button className='add-task remove-task' onClick={() => markAsDone(index)} style={task.done ? doneButtonStyle : restButtonStyle}>
            ...
            <button className='add-task' onClick={handleTasks} style={addTaskButtonStyle}>Add task</button>
        </div>
    );
}
